  ...
  return (
    <div className='  topbar w-full flex items-center justify-between py-3 md:py-6 px-4 bg-primary rounded-xl'>
      ...
      >
        <TextInput
          placeholder='Search...'
          styles='w-[18rem] lg:w-[38rem]   py-3 '
          register={register("search")}
        />
        <CustomButton
          title='search'
          type='submit'
          containerStyles='bg-[#da474f] text-white px-6 py-2.5 mt-2 rounded border'
        />
      </form>
      ...
      <div className='flex gap-4 items-center text-ascent-1 text-md md:text-xl'>
        ...
        <div>
          <CustomButton
            ...
            title='Log Out'
            containerStyles=' bg-[#da474f] text-white text-sm text-ascent-1 px-4 md:px-6 py-1 md:py-2 border border-[#666] rounded-full'
          />
        </div>
      </div>
    </div>
