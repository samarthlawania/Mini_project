...
import { BiImage, BiImages, BiSolidVideo } from "react-icons/bi";
    ...
    <div className='w-full px-0 lg:px-10 pb-20 2xl:px-40 bg-bgColor lg:rounded-lg h-screen overflow-hidden'>
        <TopBar />
         <div className='w-full flex gap-2 lg:gap-4 pt-5 pb-10 h-full'>
          ...
          {/* centre */}
          <div className=' flex-1 h -full bg-primary px flex flex-col gap-- overflow-y-auto rounded-xl '>
            <form 
            onSubmit={handlePostSubmit(handlePostSubmit)}
            className='bg-primary px-4 rounded-lg'>
              <div className='w-full flex items-center gap-2 py-4 border-b  border-[#666]'>
                <img
                src={user.profileUrl}
                alt='UserImage'
          ...
          <div className='hidden w-1/4 h-full lg:flex flex-col gap-8 overflow-y-auto'>
            ...
            <div className='w-full bg-primary shadow-sm rounded-lg px-6 py-5'>
              ...
              <div className='w-full flex flex-col gap-4 pt-4'>
                {friendRequest?.map(({requestFrom: from }) => (
